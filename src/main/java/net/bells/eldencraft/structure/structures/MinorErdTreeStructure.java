package net.bells.eldencraft.structure.structures;
...
public class MinorErdTreeStructure extends StructureFeature<NoneFeatureConfiguration> {
    public MinorErdTreeStructure(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public StructureStartFactory<NoneFeatureConfiguration> getStartFactory() {
        return MinorErdTreeStructure.Start::new;
    }
    ...
    private static final List<MobSpawnSettings.SpawnerData> STRUCTURE_MONSTERS = ImmutableList.of(
            new MobSpawnSettings.SpawnerData(EntityType.BEE, 100, 4, 15),
            new MobSpawnSettings.SpawnerData(EntityType.PARROT, 100, 4, 15)
    );
    @Override
        ...
        public void generatePieces(RegistryAccess dynamicRegistryAccess, ChunkGenerator chunkGenerator, StructureManager structureManager, ChunkPos chunkPos, Biome biomeIn, NoneFeatureConfiguration config, LevelHeightAccessor heightLimitView) {
            ...
            JigsawPlacement.addPieces(
                    ...
                    new JigsawConfiguration(() -> dynamicRegistryAccess.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(EldenCraft.MOD_ID, "minor_erdtree/start_pool")),
            ...
            EldenCraft.LOGGER.log(Level.DEBUG, "Erd Tree at " + this.pieces.get(0).getBoundingBox().getCenter());
        }
    }
}