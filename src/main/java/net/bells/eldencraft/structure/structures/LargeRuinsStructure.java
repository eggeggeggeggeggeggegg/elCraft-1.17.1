...
public class LargeRuinsStructure extends StructureFeature<NoneFeatureConfiguration> {
    public LargeRuinsStructure(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public StructureStartFactory<NoneFeatureConfiguration> getStartFactory() {
        return LargeRuinsStructure.Start::new;
    }
