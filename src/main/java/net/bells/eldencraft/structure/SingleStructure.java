...
public class SingleStructure extends StructureFeature<NoneFeatureConfiguration> {
    public SingleStructure(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public StructureStartFactory<NoneFeatureConfiguration> getStartFactory() {
        return SingleStructure.Start::new;
    }
        ...
        public void generatePieces(RegistryAccess dynamicRegistryAccess, ChunkGenerator chunkGenerator, StructureManager structureManager, ChunkPos chunkPos, Biome biomeIn, NoneFeatureConfiguration config, LevelHeightAccessor heightLimitView) {
            ...
            JigsawPlacement.addPieces(
                    ...
                    new JigsawConfiguration(() -> dynamicRegistryAccess.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            .get(new ResourceLocation(EldenCraft.MOD_ID, "divine_tower/start_pool")),
            ...
            JigsawPlacement.addPieces(
                    ...
                    new JigsawConfiguration(() -> dynamicRegistryAccess.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            ...
                            // This is why your pool files must be in "data/<modid>/worldgen/template_pool/<the path to the pool here>"
                            // because the game automatically will check in worldgen/template_pool for the pools.
                            .get(new ResourceLocation(EldenCraft.MOD_ID, "large_ruins/start_pool")),
            ...
            EldenCraft.LOGGER.log(Level.DEBUG, "Divine Tower at " + this.pieces.get(0).getBoundingBox().getCenter());
        }
    }
}